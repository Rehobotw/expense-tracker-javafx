...
public class EditIncomeController implements Initializable {
    ...
    public void setIncomeData(Income income) {
        ...
        categoryComboBox.setValue(income.getCategory());
        descriptionField.setText(income.getDescription());

        try {
            datePicker.setValue(LocalDate.parse(income.getDate()));
        } catch (Exception e) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        categoryComboBox.setItems(FXCollections.observableArrayList(
                Arrays.asList("Food", "Traveling", "Subscription", "Shopping",
    ...
    private void handleOK() {
        ...
        try {
            ...
            currentIncome.setCategory(categoryComboBox.getValue());
            currentIncome.setDate(datePicker.getValue().toString());
            currentIncome.setDescription(descriptionField.getText());

            // Save via Service
            boolean success = incomeService.updateIncome(currentIncome);
